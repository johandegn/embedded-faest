...
if __name__ == '__main__':
    # Load data from file
    variant = "256"
    data = load_file_into_array(f"vk_box/{variant}F.txt")
    ...
    with open(f"test/saved-results/access-pattern/vk_box/comp-{variant}.txt", 'w') as file:
